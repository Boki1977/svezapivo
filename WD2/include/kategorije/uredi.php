                                        ...
                                        <div class="widget-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12"><label>Naslov</label>
                                                        <input type="text" class="form-control" name="category_title" placeholder="category_title" value="<?php echo $category_title; ?>"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span class="input-icon icon-right">
                                                                            	    <input id="fieldID" type="text" value="<?php echo $category_fotka; ?>" name="category_fotka" class="fotka_refresh">
