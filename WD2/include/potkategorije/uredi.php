...
");
 ...
 while ($obj=mysqli_fetch_object($result))
 
    {
    	...
    	$kategorija_title=($obj->category_title);
    }
                                        ...
                                        <div class="widget-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12"><label>Naslov</label>
                                                        <input type="text" class="form-control" name="category_title" value="<?php echo $category_title; ?>" placeholder="Naslov"
                                                ...
                                                <div class="form-group">
                                                <div class="col-lg-12">
                                                        <textarea class="form-control" placeholder="Opis" name="category_description" rows="10"><?php echo $category_description; ?></textarea>
                                                    </div>
                                                ...
                                                <option value="<?php echo $categoryID; ?>"><?php echo $kategorija_title; ?></option>
                                                <?php
                                                $result = $con->query("

                                                SELECT * FROM tblnewscategories WHERE categoryID!='$categoryID'
