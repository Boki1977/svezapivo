 ...
 <form id="registrationForm" method="post" action="unos_shop_kategorije.php"
                                        ...
                                        <div class="widget-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12"><label>Naslov</label>
                                                        <input type="text" class="form-control" name="naziv" placeholder="Naslov"
                                                ...
                                                <div class="form-group">
                                                <div class="col-lg-12">
                                                        <textarea class="form-control" placeholder="Opis" name="opis" rows="10"></textarea>
                                                    </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span class="input-icon icon-right">
                                                                            	    <input id="fieldID" type="text" value="" name="fotografija" class="fotka_refresh">
